...
<body style="background-color:#212529;">
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; margin-right:75px;">
                        <a class="nav-link text-nowrap active" href="aboutUs.php">About Us</a>
                    </li>
                </ul>
            </b>
        </div>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="photo.jpg"alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Harshita Shrivas</h1>
            <p style="color:gray;"><b>Intern at The Sparks Foundation <br> Baderia Global The Best, Jabalpur(M.P)</b></p>
    </center>
