...
<body style="background-image:url(bank); padding-top:10%;"  >
...
<div id="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="allcust.php">View All Customers</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="transaction.php">Transactions</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="contactus.php">Contact Us</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px; margin-right:75px;">
                        <a class="nav-link text-nowrap" href="aboutUs.php">About Us</a>
                    </li>
                </ul>
            </b>
        </div>
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:2px; text-shadow:3px 3px 3px black; text-align:center; colour: white "><b>Welcome to <br> Sparks
                        Bank</b></p>
            </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:3px 3px 15px black; color:white;"><b>Our Facilities</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#343a40; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px black; padding:20px 10px 20px 10px;">
                    ...
                    <div class="col-lg">
                        <div
                            ...
                            <a href="sendmoney.php"><button type="button" class="btn btn-outline-light mybtn" >Transfer
                                    Money</button></a><br>
                    ...
                    <div class="col-lg">
                        <div
                            ...
                            <a href="checkblc.php"><button type="button" class="btn btn-outline-light mybtn">Check
                                    Balance</button></a><br>
